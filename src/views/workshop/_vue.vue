                ...
                <div class="accordin-content">
                    ...
                    >
                        <code class="language-html" v-prism>
                            &lt;li v-for="item in lists.reverse().slice(0, 12)" :key="item.id"&gt;&lt;li&gt;
                        </code>
                    </pre>
                    ...
                    >
                        <code class="language-html" v-prism>
                            &lt;li v-for="item in filteredData" :key="item.id"&gt;&lt;li&gt;
                        </code>
                    </pre>
                </div>
        ...
        <div class="text-accordin is-others">
            ...
            <div class="accordin-item" :class="isActive==3002 ? 'is-active' : ''">
                ...
                <div class="accordin-content">
                    ...
                    >
                        <code class="language-html" v-prism>
                            &lt;button @click="goBackClick"&gt;BACK&lt;/button&gt;
                        </code>
                    </pre>
                    <p><br></p>
            ...
            <div class="accordin-item" :class="isActive==3007 ? 'is-active' : ''">
                ...
                <div class="accordin-content">
                    ...
                    >
                        <code class="language-html" v-prism>
                            v-if="route.path !== '/contact' && route.path !== '/about'"
                        </code>
                    </pre>
                    ...
                    >
                        <code class="language-html" v-prism>
                            v-if="!['/contact', '/about'].includes(route.path)"
                        </code>
                    </pre>
                </div>
                <button class="accordin-close" @click="toggle(0)"></button>
            ...
            <div class="accordin-item" :class="isActive==3008 ? 'is-active' : ''">
                ...
                <div class="accordin-content">
                    ...
                    >
                        <code class="language-html" v-prism>
                            &lt;img :src="item.img.replace('/img/website/', '/img/footer/logos/')" /&gt;
                        </code>
                    </pre>
        ...
        <div class="text-accordin is-tips">
            ...
            <div class="accordin-item" :class="isActive==4002 ? 'is-active' : ''">
                ...
                <div class="accordin-content">
                    ...
                    >
                        <code class="language-html" v-prism>
                            &lt;ul ref="draggableTabs" class="draggable-tabs"&gt;
                                &lt;li&gt;項目一&lt;/li&gt;
                                &lt;li&gt;項目二&lt;/li&gt;
                                &lt;li&gt;...&lt;/li&gt;
                            &lt;/ul&gt;
            ...
            <div class="accordin-item" :class="isActive==4003 ? 'is-active' : ''">
                ...
                <div class="accordin-content">
                    ...
                    >
                        <code class="language-html" v-prism>
                            &lt;h1&gt;&#123;&#123; Text &#125;&#125;&lt;/h1&gt;
                            &lt;button :class="{ 'is-copied': isCopied }" @click="copy"&gt;&lt;/button&gt;
                        </code>
                    </pre>
                    <p>JavaScrtipt（setup 格式）：</p>
                    <pre
