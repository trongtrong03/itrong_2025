...
<div class="text-content">
    ...
    <div class="text-block" :id="'act' + catalog[2].id">
        ...
        >
            <code class="language-javascript" v-prism>
                const dog;
                console.log(dog);    // Missing initializer in const declaration
            </code>
        </pre>
        ...
        >
            <code class="language-javascript" v-prism>
                ...
                dog.years = 3;
                console.log(dog);    // {"name": "阿比", "years": 3}
            </code>
        </pre>
    ...
    <div class="text-block" :id="'act' + catalog[4].id">
        ...
        <pre
            ...
            data-toolbar-order="copy-to-clipboard" 
        >
            <code class="language-javascript" v-prism>let let = "阿比";    // Uncaught SyntaxError: let is disallowed as a lexically bound name            </code>
        </pre>
        ...
        >
            <code class="language-javascript" v-prism>
                var 9547 = "阿比";    // Uncaught SyntaxError: Unexpected number
            </code>
        </pre>
        ...
        >
            <code class="language-javascript" v-prism>
                var &dog = "do.g";    // Uncaught SyntaxError: Unexpected token 'do'
        ...
        >
            <code class="language-javascript" v-prism>
                var dog name = "阿比";    // Uncaught SyntaxError: Unexpected identifier 'name'
            </code>
        </pre>
        <p><br></p>
        <h3>命名方式：</h3>
