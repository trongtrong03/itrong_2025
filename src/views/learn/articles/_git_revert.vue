...
<div class="text-content">
    ...
    <div class="text-block" :id="'act' + catalog[1].id">
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">f4cb6e9 (HEAD -> master) C3
e39824f C2
a60510b C1</code></pre>
            </div>
        </prism-highlight>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git revert e39824f</code></pre>
            </div>
        </prism-highlight>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">ff10266 (HEAD -> master) Revert "C2"
f4cb6e9 C3
e39824f C2
a60510b C1</code></pre>
            </div>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git cherry-pick e39824f</code></pre>
            </div>
        </prism-highlight>
        <p>如此哈希值 <em>e39824f</em> 所代表的 C2 提交版本的內容就會重新引入到最新的 commit 上了，我們可以透過 <em>git log --oneline</em> 來確認歷史記錄：</p>
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">decdfa7 (HEAD -> master) C2
ff10266 Revert "C2"
f4cb6e9 C3
e39824f C2
a60510b C1</code></pre>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git revert abc123</code></pre>
            </div>
        </prism-highlight>
        <p><br></p>
...
a60510b C1</code></pre>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git reset --soft e39824f</code></pre>
            </div>
        </prism-highlight>
        <p>再 <em>git log</em> 查詢一次，會發現記錄變成：</p>
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">e39824f (HEAD -> master) C2
a60510b C1</code></pre>
            </div>
        </prism-highlight>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">95a98d0 (HEAD -> master) C3:new
e39824f C2
a60510b C1</code></pre>
            </div>
        </prism-highlight>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git reset --mixed e39824f</code></pre>
            </div>
        </prism-highlight>
        <p>查詢日誌歷史記錄：</p>
        <prism-highlight>
...
a60510b C1</code></pre>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git reset --hard e39824f</code></pre>
            </div>
        </prism-highlight>
...
nothing to commit, working tree clean</code></pre>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git reflog</code></pre>
            </div>
        </prism-highlight>
        <p>將會看到以下這些輸出：</p>
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">f4cb6e9 (HEAD) HEAD@{0}: checkout: moving from master to f4cb6e9
...
a60510b HEAD@{10}: commit (initial): C1</code></pre>
            </div>
        </prism-highlight>
        <p>這些包含了前面我們練習各種 reset 模式所累積的提交記錄，假設我們想恢復 <em>f4cb6e9</em> 這個最初的 C3 版本，我們可以透過以下兩種指令去實現：</p>
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git reset --hard f4cb6e9</code></pre>
            </div>
        </prism-highlight>
        <p>或</p>
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git checkout f4cb6e9</code></pre>
            </div>
        </prism-highlight>
        <p>接著使用 <em>git log --oneline</em> 查看日誌歷史記錄：</p>
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">f4cb6e9 (HEAD) C3
e39824f (master) C2
a60510b C1</code></pre>
            </div>
        </prism-highlight>
...
* (HEAD detached from f4cb6e9)
  master</code></pre>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">git checkout -b "test"
                </code></pre>
            </div>
        </prism-highlight>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">b3cffb6 (HEAD -> test) C4
f4cb6e9 C3
e39824f (master) C2
a60510b C1</code></pre>
            </div>
...
git merge test</code></pre>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-git">b3cffb6 (HEAD -> master, test) C4
f4cb6e9 C3
e39824f C2
a60510b C1</code></pre>
            </div>
