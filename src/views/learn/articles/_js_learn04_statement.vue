...
// a 比 b 小</code></pre>
    ...
    console.log("a 比 b 小");
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-javascript">switch (condition) {
    case value1:
        statement1;
        break;
    ...
    default:
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-javascript">function checkColor(e){
    var color = e;
    switch(color){
        case "red":
            console.log("紅色");
...
// 1 3 5 7 9</code></pre>
    ...
    <div class="text-block" :id="'act' + catalog[4].id">
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-javascript">throw expression;</code></pre>
            </div>
        </prism-highlight>
        ...
        <prism-highlight>
            <div class="text-code" v-pre>
                <pre><code class="language-javascript">throw "阿比";    // 字串
throw 33;    // 數字
throw true;    // 布林值
throw function() {
    return "我是函式!";
