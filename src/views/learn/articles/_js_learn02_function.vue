...
<div class="text-content">
    ...
    <div class="text-block" :id="'act' + catalog[1].id">
        ...
        >
            <code class="language-javascript" v-prism>
                var addNumber = new Function('a', 'b', 'return a + b');

                var result = addNumber(5, 10);    // 15
            </code>
        </pre>
        ...
        >
            <code class="language-javascript" v-prism>
                ...
                dog();    // Uncaught ReferenceError: dog is not defined.
            </code>
        </pre>
    ...
    <div class="text-block" :id="'act' + catalog[3].id">
        ...
        <pre
            ...
            data-toolbar-order="copy-to-clipboard" 
        >
            <code class="language-html" v-prism>&lt;a href="javascript:函式名稱()"&gt;&lt;/a&gt;            </code>
        </pre>
    </div>
    <div class="text-block" :id="'act' + catalog[4].id">
        ...
        >
            <code class="language-javascript" v-prism>
                return "阿比";    // Uncaught SyntaxError: Illegal return statement.
            </code>
        </pre>
        ...
        <pre
            ...
            data-toolbar-order="copy-to-clipboard" 
        >
            <code class="language-javascript" v-prism>function calculateArea(width, height) {
    var area = width * height;
    console.log(area);
    return area;
    console.log(area);    // 不會被執行
        ...
        >
            <code class="language-javascript" v-prism>
                ...
                console.log(dog("阿比"));    // 阿比, undefined
            </code>
        </pre>
    ...
    <div class="text-block" :id="'act' + catalog[5].id">
        ...
        >
            <code class="language-javascript" v-prism>
                function dog(name, year, gender="公") {
                    console.log(name, year, gender);
                }
        ...
        <pre
            ...
            data-toolbar-order="copy-to-clipboard" 
        >
            <code class="language-javascript" v-prism>function dog(name, year, gender) {
