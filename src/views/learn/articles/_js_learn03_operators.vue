...
<div class="text-content">
    ...
    <div class="text-block" :id="'act' + catalog[1].id">
        ...
        >
            <code class="language-javascript" v-prism>
                var dog;    // 沒有指定值，所以只是單純的敘述句
                dog = "阿比";    // 有指定值，可視為運算式
                var x = "阿比" + "蹦蹦跳";    // 等號左邊敘述變數宣告，右邊賦值，可視為運算式
            </code>
        </pre>
    </div>
    ...
    <div class="text-block" :id="'act' + catalog[3].id">
        ...
        >
            <code class="language-javascript" v-prism>
                ...
                let newDog = new dog();
                console.log(newDog);    // [object Object] { "name": "阿比" }
            </code>
        </pre>
        ...
        >
            <code class="language-javascript" v-prism>
                ...
                console.log(array2);    // [1, 2, 3, "apple", "banana"]
            </code>
        </pre>
        ...
        >
            <code class="language-javascript" v-prism>
                ...
                console.log(array1.concat(array2)); // [1, 2, 3, "apple", "banana"]
            </code>
        </pre>
        <p><br></p>
        ...
        >
            <code class="language-javascript" v-prism>
                ...
                console.log(array2); // ["apple", "banana", "orange", "grape"]
            </code>
        </pre>
    ...
    <div class="text-block" :id="'act' + catalog[4].id">
        ...
        >
            <code class="language-javascript" v-prism>
                ...
                var final = (score1 + score2) > (average1 + average2);    // true
            </code>
        </pre>
        ...
        >
            <code class="language-javascript" v-prism>
                var firstName = "狗";
                var lastName = "阿比";
                var fullName = firstName + lastName;    // 狗阿比
            </code>
        </pre>
        ...
        >
            <code class="language-javascript" v-prism>
                var number1 = '10';
                var number2 = '99';
                var final = number1 + number2;    // 1099
            </code>
        </pre>
        <p><br></p>
        <h4>2. 數值與字串相加：</h4>
